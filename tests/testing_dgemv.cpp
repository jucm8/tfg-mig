/*
    -- MAGMA (version 2.7.0) --
       ...
       @generated from testing/testing_zgemv.cpp, normal z -> d, Thu Nov 10 21:02:31 2022
*/
// includes, system
#include <stdlib.h>
#include <stdio.h>
...
int main(int argc, char **argv)
{
    ...
    for( int itest = 0; itest < opts.ntest; ++itest ) {
        ...
        tol = (M < 20000 && N < 20000 ? 3*eps : opts.tolerance*eps);
            ...
            status += ! okay;
            printf("%5lld %5lld   %7.2f (%7.2f)    %7.2f (%7.2f)   %7.2f (%7.2f)    %8.2e     %8.2e\n",
            ...
            status += ! okay;
            printf("%5lld %5lld   %7.2f (%7.2f)   %7.2f (%7.2f)    %8.2e\n",
                    (long long) M, (long long) N,
                    dev_perf,    1000.*elapsed,
                    cpu_perf,    1000.*cpu_time,
                    dev_error);
